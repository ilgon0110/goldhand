...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/manager/about`, lastModified: '2026-08-31', changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/reservation`, lastModified: '2026-08-31', changeFrequency: 'monthly', priority: 0.9 },
