  ...
  return (
    <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-xl font-semibold tracking-tight text-balance text-gray-900 sm:text-3xl">
          게시글 조회 중 에러가 발생하였습니다.
        </h1>
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <button
            onClick={() => reset()}
            className="text-sm font-semibold text-gray-900 flex flex-row gap-1 items-center"
          >
            새로고침
